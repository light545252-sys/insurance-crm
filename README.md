[README.md](https://github.com/user-attachments/files/28104595/README.md)
# 亮業務 CRM 🏢
...
**如果 Proxy 掛掉（Failed to fetch）：**
1. 確認 `notion-proxy.light545252.workers.dev` 是否正常
2. 如需重建，參考上方「Cloudflare Workers Proxy」段落
3. 新 Proxy 網址更新至 `index.html` 第 1075 行的 `PROXY` 常數
